...
***************************************************************************** */
        ...
        galleries.forEach((gallery => {
            galleyItems.push({
                ...
                galleryClass: lightgallery_es5(gallery, {
                    selector: ".item-collections__image",
    ...
    if (document.querySelector(".timer")) {
        ...
        const saleDate = "1 Feb 2025 19:00:00";
        function countdown() {
            const newSaleDate = new Date(saleDate);
            const currentDate = new Date;
            const totalSeconds = (newSaleDate - currentDate) / 1e3;
    ...
    if (document.querySelector(".rank")) document.addEventListener("DOMContentLoaded", (function() {
        var mixer = mixitup(".rank__list", {
            animation: {
