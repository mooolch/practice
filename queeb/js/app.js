(() => {
    ...
    function initSliders() {
        if (document.querySelector(".categories__slider", ".tranding__slider")) {
            new core(".categories__slider", {
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        var mixer = mixitup(".collections__items", {
            animation: {
                effects: "fade stagger(70ms)",
